...
def load_configs_initialize_training():
    ...
    parser.add_argument("-sd", "--save_dataset_images", action="store_true", help="save fake images generated by the GAN to create a balanced dataset.")
    parser.add_argument("-sf_num", "--save_fake_images_num", type=int, default=1, help="number of fake images to save")
    parser.add_argument("-sd_num", "--save_dataset_images_num", type=int, default=1, help="number of fake images to save for each class")
